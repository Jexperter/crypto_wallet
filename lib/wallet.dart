...
import 'package:web3_wallet/get_balances.dart';
import 'package:web3_wallet/send_tokens.dart';
import 'package:web3_wallet/wallet_provider.dart';
import 'package:web3_wallet/create_or_import.dart';
...
class _WalletPageState extends State<WalletPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromRGBO(0, 150, 255, 1), // Set background color here
      body: Column(
          ...
          Expanded(
            child: DefaultTabController(
              ...
              child: Column(
                children: [
                  const TabBar(
                    labelColor: Color.fromARGB(255, 243, 244, 245),
                    tabs: [
                      Tab(text: 'Assets'),
                      Tab(text: 'Options'),
                    ],
